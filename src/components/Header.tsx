      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-medical-600 text-white rounded-xl hover:from-primary-700 hover:to-medical-700 transition-all duration-200 shadow-lg hover:shadow-xl font-medium">
          ...
          <div className="md:hidden py-4 border-t border-primary-100 bg-white/95 backdrop-blur-md">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-3 pt-4">
                ...
                <button className="flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-medical-600 text-white rounded-xl hover:from-primary-700 hover:to-medical-700 transition-all duration-200 shadow-lg font-medium">
                  <Phone className="w-4 h-4" />
                  <span>Book a Test</span>
                </button>
              </div>
